...
package com.wasteofplastic.acidisland.nms.v1_13_R1;
...
public class NMSHandler implements NMSAbstraction {
   ...
   public void setBlockSuperFast(Block b, Material blockId, byte data, boolean applyPhysics) {

	   b.setType(blockId, applyPhysics);
    }
    ...
    public ItemStack setBook(Tag item) {
        ...
        if (((CompoundTag) item).getValue().containsKey("tag")) {
            ...
            net.minecraft.server.v1_13_R1.ItemStack stack = CraftItemStack.asNMSCopy(chestItem); 
    ...
    public void setFlowerPotBlock(final Block block, final ItemStack itemStack) {
        ...
        if (block.getType().equals(Material.FLOWER_POT)) {
            ...
            Flow te = (TileEntityFlowerPot)cw.getHandle().getTileEntity(bp);

            //Bukkit.getLogger().info("Debug: flowerpot materialdata = " + (new ItemStack(potItem, 1,(short) potItemData).toString()));

            net.minecraft.server.v1_13_R1.ItemStack cis = CraftItemStack.asNMSCopy(itemStack);
	...
	public ItemStack getSpawnEgg(Material type, int amount) {
		ItemStack egg = new ItemStack(type, amount);
		return egg;
	}
